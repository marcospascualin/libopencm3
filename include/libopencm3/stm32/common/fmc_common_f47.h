...
/* FSMC BCRx Mask */
#define FMC_BCR_MBKEN_SET ((uint32_t)0x00000001)
#define FMC_BCR_MBKEN_RESET ((uint32_t)0x000FFFFE)
#define FSMC_BCR_MTYP_SRAM 0
#define FSMC_BCR_MTYP_PSRAM (1 << 2)
#define FSMC_BCR_MTYP_NOR (1 << 3)

/* FSMC SR Mask */
#define FSMC_SR_READY (1 << 5)

/* FSMC BWTRx Mask */
#define FSMC_BWTR_ACCMODx(x) (((x) & 0x03) << 28)
#define FSMC_BWTR_DATLATx(x) (((x) & 0x0f) << 24)
#define FSMC_BWTR_CLKDIVx(x) (((x) & 0x0f) << 20)
#define FSMC_BWTR_DATASTx(x) (((x) & 0xff) << 8)
#define FSMC_BWTR_ADDHLDx(x) (((x) & 0x0f) << 4)
#define FSMC_BWTR_ADDSETx(x) (((x) & 0x0f) << 0)
