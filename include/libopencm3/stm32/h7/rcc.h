...
#define RCC_BDCR MMIO32(RCC_BASE + 0x070)
#define RCC_CSR MMIO32(RCC_BASE + 0x074)
...
#define RCC_AHB3LPENR MMIO32(RCC_BASE + 0x0FC)
...
#define RCC_C1_RSR (RCC_RSR + 0x60)
#define RCC_C1_AHB3ENR (RCC_AHB3ENR + 0x60)
#define RCC_C1_AHB1ENR (RCC_AHB1ENR + 0x60)
#define RCC_C1_AHB2ENR (RCC_AHB2ENR + 0x60)
#define RCC_C1_AHB4ENR (RCC_AHB4ENR + 0x60)
#define RCC_C1_APB3ENR (RCC_APB3ENR + 0x60)
#define RCC_C1_APB1LENR (RCC_APB1LENR + 0x60)
#define RCC_C1_APB1HENR (RCC_APB1HENR + 0x60)
#define RCC_C1_APB2ENR (RCC_APB2ENR + 0x60)
#define RCC_C1_APB4ENR (RCC_APB4ENR + 0x60)
#define RCC_C1_AHB3LPENR (RCC_AHB3LPENR + 0x60)
#define RCC_C1_AHB1LPENR (RCC_AHB1LPENR + 0x60)
#define RCC_C1_AHB2LPENR (RCC_AHB2LPENR + 0x60)
#define RCC_C1_AHB4LPENR (RCC_AHB4LPENR + 0x60)
#define RCC_C1_APB3LPENR (RCC_APB3LPENR + 0x60)
#define RCC_C1_APB1LLPENR (RCC_APB1LLPENR + 0x60)
#define RCC_C1_APB1HLPENR (RCC_APB1HLPENR + 0x60)
